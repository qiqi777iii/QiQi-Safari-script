import { HStack, Image, Text, VStack, Widget, type ShapeStyle } from "scripting"
...
function WidgetView({ info }: { info: IPInfo }) {
  ...
  if (compact) {
    return <VStack
      ...
      alignment="center"
      spacing={4}
      widgetURL="scripting://run/IP%E6%9F%A5%E8%AF%A2"
    >
...
function EmptyWidget() {
  return <VStack padding={16} alignment="center" spacing={8} widgetURL="scripting://run/IP%E6%9F%A5%E8%AF%A2">
    <Image systemName="network" foregroundStyle="systemBlue" font={24} />
    <Text font="headline" fontWeight="bold">点按查询当前 IP</Text>
    <Text font="caption" foregroundStyle="secondaryLabel">查询后结果会显示在这里</Text>
  </VStack>
}
